...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(register|login|apiww)'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(month|profile)'), [0 => 'ROLE_USER'], NULL);
